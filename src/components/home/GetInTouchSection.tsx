      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          ...
          >
            ...
            <p className="text-primary-light text-base font-semibold">043971720</p>
          </a>

          <a
            href="sms:043971720?body=Hi, I'm interested in Fresh Plus cleaning services."
            className="group bg-white/10 backdrop-blur-sm p-6 rounded-2xl hover:bg-white/20 transition-all duration-300 transform hover:scale-105 border border-white/20 text-center"
          >
          ...
          >
            ...
            <p className="text-primary-light text-sm break-all px-2">Info@freshpluscleaning.com.au</p>
          </a>
