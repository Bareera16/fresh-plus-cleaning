            ...
            <main className="relative min-h-screen bg-white overflow-hidden" style={{ fontFamily: "'Times New Roman', Times, serif" }}>
                ...
                >
                    ...
                    <div className="max-w-7xl mx-auto relative z-10">
                        ...
                        >
                            Window Cleaning <span className="text-green-400">Melbourne</span>
                        </motion.h1>
                        ...
                        <div className="mt-10 flex flex-wrap justify-center gap-4">
                            ...
                            <a href="tel:0431977720" className="bg-white border-2 border-green-900 text-green-900 px-8 py-4 font-black uppercase text-[12px] tracking-widest transition-all shadow-lg hover:-translate-y-1 block text-center flex items-center justify-center">
                                Call 0431 977 720
                            </a>
                        </div>
                    </div>
