    ...
    <main className="relative min-h-screen bg-white overflow-hidden" style={{ fontFamily: "'Times New Roman', Times, serif" }}>
      ...
      <section className="py-24 px-6">
        <motion.div 
          ...
          className="bg-blue-700 rounded-[3.5rem] p-12 text-center text-white shadow-2xl relative overflow-hidden max-w-7xl mx-auto"
        >
          <div className="relative z-10">
            <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter mb-6">Ready for a Spotless Home?</h2>
            <button className="bg-white text-blue-700 px-10 py-4 rounded-full font-black uppercase text-[11px] tracking-widest hover:bg-black hover:text-white transition-all shadow-lg">
              Get Started Now
            </button>
          </div>
