...
import { Check, CheckCircle2, Zap, Shield, Clock, Sun } from "lucide-react";

// Content based on user's Solar Panel Services image
const solarServices = [
    {
        title: "Efficiency Restoration",
        desc: "Remove dirt and debris to maximize solar panel energy output and ROI.",
        icon: <Zap size={40} className="text-brand-orange" />
    },
    {
        title: "Longevity Protection",
        desc: "Gentle cleaning that protects panel surfaces and extends system lifespan.",
        icon: <Shield size={40} className="text-brand-orange" />
    },
    {
        title: "Regular Maintenance",
        desc: "Scheduled cleaning services to keep panels performing at peak efficiency.",
...
const plans = [
    {
        ...
        desc: "Perfect for home solar setups (up to 20 panels).",
        features: ["Chemical-free pure water", "Spot -free rinse", "Deionized water tech", "Visual inspection"],
        btn: "Get Quote",
    ...
    {
        name: "Large Handover",
        desc: "For larger residential properties (20-40 panels).",
        features: ["Output report check", "Inverter display check", "Bird fouling removal", "Priority scheduling"],
        btn: "Get Quote",
    ...
    },
    {
        ...
        desc: "Large scale solar farms and business rooftops.",
        features: ["Maintenance contract", "Drone inspection option", "Detailed efficiency report", "After-hours service"],
        btn: "Contact Us",
        color: "border-brand-blue-light",
        btnColor: "bg-brand-blue"
    }
...
const locations = [
    "Melbourne CBD", "Werribee", "Point Cook", "Tarneit", "Truganina",
    "Sunbury", "Craigieburn", "Epping", "Mernda", "Doreen",
    "Cranbourne", "Pakenham", "Berwick", "Narre Warren", "Rowville"
];
    ...
    return (
        <section className="relative h-auto py-32 flex items-center justify-center overflow-hidden">
            ...
            <div
                ...
                style={{
                    backgroundImage: "url('/solarpanel.webp')",
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6">
                <div className="text-center mb-20">
                    <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter text-white">
                        Solar Panel <span className="text-brand-green">Services</span>
                    </h2>
    ...
    return (
        <main className="relative min-h-screen bg-white overflow-hidden" style={{ fontFamily: "'Times New Roman', Times, serif" }}>
            ...
            <motion.div
                ...
                className="relative pt-32 pb-20 px-6 bg-gradient-to-b from-brand-green-light to-white text-center"
            >
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        Solar Panel <span className="text-brand-green">Cleaning</span>
                    </motion.h1>
                    ...
                    >
                        <Image src="/solarpanel.webp" alt="Solar Panel Cleaning" width={1200} height={600} priority className="w-full h-auto object-cover" />
                    </motion.div>
            ...
            {/* 4. PLANS/PACKAGES (Master Green Card) */}
            <section className="py-24 px-6 md:px-12 bg-white">
                ...
                >
                    <div className="text-center mb-16 relative z-10">
                        ...
                        >
                            Affordable maintenance for your renewable energy investment.
                        </motion.p>
                    </div>
