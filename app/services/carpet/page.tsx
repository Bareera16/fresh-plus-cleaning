...
const servicesList = [
    ...
    },
    {
        ...
        desc: "Revitalize your sofas and chairs with our gentle cleaning.",
        img: "/cleaner3.avif"
    }
];
...
const plans = [
    {
        name: "Standard Clean",
        desc: "Ideal for freshening up your rooms.",
        features: ["Steam cleaning", "Deodorizing", "Stain pre-treatment", "Satisfaction guarantee"],
        btn: "See Pricing",
    ...
    },
    {
        ...
        desc: "Best for heavy traffic areas and longevity.",
        features: ["Deep scrub", "Scotchgard protection", "Sanitization", "Fast dry process"],
        btn: "See Pricing",
    ...
    {
        name: "End of Lease",
        desc: "Get your bond back with our guaranteed clean.",
        features: ["Intensive clean", "Receipt provided", "Stain treatment", "Pet hair removal"],
        btn: "See Pricing",
        color: "border-brand-blue-light",
        btnColor: "bg-brand-blue"
    }
        ...
        <main className="relative min-h-screen bg-white overflow-hidden" style={{ fontFamily: "'Times New Roman', Times, serif" }}>
            ...
            >
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        Carpet Cleaning <span className="text-brand-green">Melbourne</span>
                    </motion.h1>
                    ...
                    >
                        Revitalize your carpets with our deep steam cleaning service.
                    </motion.p>
