...
export default function SmoothContactPage() {
  return (
            ...
            >
              ...
              <form className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-10">
                <div className="space-y-2">
                  ...
                  <input type="text" placeholder="Your Name" className="w-full border-b-2 border-gray-100 py-3 focus:border-green-600 outline-none transition-all" />
                </div>
                <div className="space-y-2">
                  <label className="text-[11px] font-black text-gray-400 uppercase tracking-widest">Mobile Number</label>
                  <input type="text" placeholder="04XX XXX XXX" className="w-full border-b-2 border-gray-100 py-3 focus:border-green-600 outline-none transition-all" />
                </div>
                <div className="md:col-span-2 space-y-2">
                  <label className="text-[11px] font-black text-gray-400 uppercase tracking-widest">Email Address</label>
                  <input type="email" placeholder="example@mail.com" className="w-full border-b-2 border-gray-100 py-3 focus:border-green-600 outline-none transition-all" />
                </div>
                <div className="md:col-span-2 space-y-2">
                  <label className="text-[11px] font-black text-gray-400 uppercase tracking-widest">Subject</label>
                  <input type="text" placeholder="How can we help?" className="w-full border-b-2 border-gray-100 py-3 focus:border-green-600 outline-none transition-all" />
                </div>
                <div className="md:col-span-2 space-y-2">
                  <label className="text-[11px] font-black text-gray-400 uppercase tracking-widest">Message Details</label>
                  <textarea rows={4} placeholder="Your cleaning needs..." className="w-full border-b-2 border-gray-100 py-3 focus:border-green-600 outline-none transition-all resize-none"></textarea>
                </div>

                <motion.button
                  whileHover={{ scale: 1.02, backgroundColor: "#15803d" }}
                  whileTap={{ scale: 0.98 }}
                  className="md:col-span-2 bg-green-600 text-white font-black py-5 px-10 rounded-2xl uppercase tracking-widest transition-all shadow-2xl mt-4"
                >
                  Submit Request
                </motion.button>
              </form>
